jQuery(function(s) {
    var e = [
        ["#customize-theme-controls", "all", "ct-reset", "ct-reset-main", shopSpotCustomizerReset.confirm, shopSpotCustomizerReset.reset]
    ];
    s.each(e, function(e, o) {
        ...
        c.on("click", function(e) {
            ...
            var t = {
                ...
                nonce: shopSpotCustomizerReset.nonce.reset,
                section: o[1]
            };
