<?php
/**
 * Shop Spot Theme Options Sanitization Functions
 *
 * @package Shop_Spot
 */
 ...
 * @since 1.0.0
 */
function shop_spot_sanitize_project_type( $input ) {
    if ( '' != $input ) {
        if ( in_array( 0, $input ) ) {
            return '0';
        }
 ...
 */
function shop_spot_sanitize_select( $input, $setting ) {
 ...
 */
function shop_spot_sanitize_checkbox( $checked ) {
    // Boolean check.
 ...
 */
function shop_spot_sanitize_post( $input ) {
 ...
 */
function shop_spot_sanitize_image( $image, $setting ) {
    /*
 ...
 * @since 1.0.0
 */
function shop_spot_sanitize_category_list( $input ) {
 ...
 * @since 1.0.0
 */
function shop_spot_sanitize_product_category_list( $input ) {
    if ( is_array( $input ) && '' != $input ) {
        if ( in_array( 0, $input ) ) {
            return '0';
        }
 ...
 *                    the setting default.
 */
function shop_spot_sanitize_number_range( $number, $setting ) {
